...
CATALINA_BASE=$dir_tomcat
export CATALINA_HOME=$dir_tomcat
export CATALINA_BASE=$dir_tomcat
TOMCAT_USER=tomcat
...
su - \$TOMCAT_USER -c "export CATALINA_HOME=$dir_tomcat && export CATALINA_BASE=$dir_tomcat && \$CATALINA_HOME/bin/startup.sh"
RETVAL=\$?
echo
